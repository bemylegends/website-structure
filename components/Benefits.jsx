        ...
        <div className="wrap">
          ...
          <div className="bento">
            ...
            <article className="b b2 rv d1">
              ...
              <h3>Co-investment rooms</h3><p>Share allocations, find a lead or join one.</p>
            </article>
            ...
            <article className="b b4 rv">
              ...
              <h3>Private rooms</h3><p>InvestHack, Closed Room and small dinners.</p>
            </article>
            ...
            <article className="b b6 rv d2">
              ...
              <h3>A clean room</h3><p>Investors only. No vendors, no pitch sellers.</p>
            </article>
          </div>
        </div>
      </section>
